...
const PasswordRequirement = ({ met, label }: { met: boolean; label: string }) => (
  <div className="flex items-center gap-1.5">
    ...
    <span className={`text-xs font-body ${met ? "text-green-500" : "text-muted-foreground/60"}`}>
      {label}
    </span>
  </div>
);
          ...
          {isForgotPassword ? (
            <>
              ...
              <form onSubmit={handleForgotPassword} className="mt-8 space-y-4">
                ...
                <Button type="submit" variant="accent" className="w-full mt-6" disabled={loading}>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                ...
                <Button
                  ...
                  disabled={loading || (isSignUp && !isPasswordStrong && password.length > 0)}
                >
              ...
              {!isSignUp && (
                <p className="mt-4 text-center">
                  <button
                    ...
                    className="text-xs text-muted-foreground hover:text-primary font-body transition-colors duration-150"
                  >
                    Lupa password?
                  </button>
                </p>
